...
| 买不到合适 N20 轮胎 | 64T 钢齿轮 + 3mm D 孔轮毂/夹片 + 防滑外圈 | 已列入备选 | 只作为后轮轮芯方案；后桥仍是左右 N20 独立半桥，不做通轴 |
...
| 四个 N20 电机 | 四驱会增加电流、驱动和机械安装复杂度，不适合 Mk.1 |
...
- 轮胎孔径必须匹配电机：N20 常用 3mm D 形轴，轮子也要 3mm D 形孔。
