...
| 角色分工 | 底盘控制板 | 接收 UART 指令，做限速/超时保护，控制四个普通 N20 + 两块 DRV8833 的左右两侧开环短时差速底盘 |
...
电机连接：前 DRV8833 AOUT 接左前 N20、BOUT 接右前 N20；后 DRV8833 AOUT 接左后 N20、BOUT 接右后 N20。若前进时某个轮反转，交换该电机两根线，或在底盘固件里配置反相。
...
- Mk.1 先采用双板方案：DualEye 通过 UART 控制底盘板，底盘板再控制普通 N20 + 两块 DRV8833 + 四轮左右两侧差速。
