...
如果买不到合适的 34 mm、3 mm D 孔 N20 橡胶轮，可以临时用 64T 钢齿轮做后轮轮芯，但需要满足这几个条件：

- 优先买外径 30-36 mm、中心 3 mm D 孔、厚 3-6 mm 的 64T 齿轮。
- 如果齿轮不是 3 mm D 孔，必须加 3 mm D 孔轮毂或 3D 打印夹片，不建议只用胶水粘在 N20 轴上。
- 钢齿轮外圈要套 O 型圈、热缩圈或橡胶圈，否则容易打滑、噪声大，也会刮桌面。
- 后桥仍是左右两个 N20 独立半桥，不使用贯穿通轴；左右轮必须能独立转动，差速转向才有效。
- 前桥继续用一个 10-20 mm 万向轮或小脚轮，按后轮实际直径加 1-2 mm 垫片调平。

后桥轴线建议距底板后边 18-22 mm。两个 N20 输出轴朝外，电机本体放在底板后部内侧，中间留 18-24 mm 给电池盒和线束。更完整的结构说明见 `docs/后桥前桥与64T齿轮轮方案_Atlas_Rover_Mk1.md`。
...
| 1 | 底板开孔 | 切 110 x 72 mm FR4/亚克力底板，钻 M2 铜柱孔、电池扎带孔、万向轮孔和电机固定孔；后轮轴线先画在距后边约 20 mm 处。 | 底板边缘打磨，M2 螺丝能顺利穿过，左右 N20 输出轴中心在同一条轴线上。 |
